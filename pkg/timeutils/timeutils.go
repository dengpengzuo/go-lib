...
func (s *Stopwatch) Print() {
    ...
    log.Infof("%s with %s", p, s.sprintStages())
}
...
func (s *Stopwatch) PrintStages() {
    ...
    log.Infof("%s took %s with %s", s.name, stagesDuration, s.sprintStages())
}
...
func (s *Stopwatch) PrintTopStages(n int) {
    ...
    log.Infof("%s took %s with %s", s.name, stagesDuration, s.sprintTopStages(n))
}
